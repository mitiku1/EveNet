...
do
    ...
    do
        python trainer/task.py --train-files ./data/filtered/output* --job-dir ./output/filterwidth/$FILTERWIDTH --sample_size 4 --filter_width $FILTERWIDTH --train-steps $(($ITERATION * $STEPSIZE))
