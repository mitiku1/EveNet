...
def run(target,
    ...
    with tf.Graph().as_default():
        ...
        with tf.device(tf.train.replica_device_setter()):
            ...
            samples = tf.placeholder(tf.float32, shape=(receptive_field_size/reader.data_dim, reader.data_dim), name="samples")
            gc = tf.placeholder(tf.int32, shape=(receptive_field_size/reader.data_dim), name="gc")
